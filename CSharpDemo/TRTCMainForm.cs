    ...
    public partial class TRTCMainForm : Form, ITRTCCloudCallback, ITRTCLogCallback,ITRTCAudioFrameCallback
    {
        ...
        private IntPtr GetHandleAndSetUserId(int pos, string userId, bool isOpenSubStream)
        {
            switch (pos)
            {
                ...
                case 6:
                    this.remoteUserLabel6.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel6.Handle;
                case 7:
                    this.remoteUserLabel7.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel7.Handle;
                case 8:
                    this.remoteUserLabel8.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel8.Handle;
                case 9:
                    this.remoteUserLabel9.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel9.Handle;
                case 10:
                    this.remoteUserLabel10.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel10.Handle;
                case 11:
                    this.remoteUserLabel11.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel11.Handle;
                case 12:
                    this.remoteUserLabel12.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel12.Handle;
                case 13:
                    this.remoteUserLabel13.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel13.Handle;
                case 14:
                    this.remoteUserLabel14.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel14.Handle;
                case 15:
                    this.remoteUserLabel15.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel15.Handle;
                case 16:
                    this.remoteUserLabel16.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel16.Handle;
                case 17:
                    this.remoteUserLabel17.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel17.Handle;
                case 18:
                    this.remoteUserLabel18.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel18.Handle;
                case 19:
                    this.remoteUserLabel19.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel19.Handle;
                case 20:
                    this.remoteUserLabel20.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel20.Handle;
                case 21:
                    this.remoteUserLabel21.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel21.Handle;
                case 22:
                    this.remoteUserLabel22.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel22.Handle;
                case 23:
                    this.remoteUserLabel23.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel23.Handle;
                default:
                    return IntPtr.Zero;
            }
        }
        ...
        private int GetRemoteVideoPosition(String userId)
        {
            if (this.remoteUserLabel1.Text.Equals(userId))
                ...
                return 5;
            else if (this.remoteUserLabel6.Text.Equals(userId))
                return 6;
            else if (this.remoteUserLabel7.Text.Equals(userId))
                return 7;
            else if (this.remoteUserLabel8.Text.Equals(userId))
                return 8;
            else if (this.remoteUserLabel9.Text.Equals(userId))
                return 9;
            else if (this.remoteUserLabel10.Text.Equals(userId))
                return 10;
            else if (this.remoteUserLabel11.Text.Equals(userId))
                return 11;
            else if (this.remoteUserLabel12.Text.Equals(userId))
                return 12;
            else if (this.remoteUserLabel13.Text.Equals(userId))
                return 13;
            else if (this.remoteUserLabel14.Text.Equals(userId))
                return 14;
            else if (this.remoteUserLabel15.Text.Equals(userId))
                return 15;
            else if (this.remoteUserLabel16.Text.Equals(userId))
                return 16;
            else if (this.remoteUserLabel17.Text.Equals(userId))
                return 17;
            else if (this.remoteUserLabel18.Text.Equals(userId))
                return 18;
            else if (this.remoteUserLabel19.Text.Equals(userId))
                return 19;
            else if (this.remoteUserLabel20.Text.Equals(userId))
                return 20;
            else if (this.remoteUserLabel21.Text.Equals(userId))
                return 21;
            else if (this.remoteUserLabel22.Text.Equals(userId))
                return 22;
            else if (this.remoteUserLabel23.Text.Equals(userId))
                return 23;
            return -1;
        }
        ...
        private int GetIdleRemoteVideoPosition(String userId)
        {
            if (string.IsNullOrEmpty(this.remoteUserLabel1.Text) || this.remoteUserLabel1.Text.Equals(userId))
                ...
                return 5;
            else if(string.IsNullOrEmpty(this.remoteUserLabel6.Text) || this.remoteUserLabel6.Text.Equals(userId))
                return 6;
            else if (string.IsNullOrEmpty(this.remoteUserLabel7.Text) || this.remoteUserLabel7.Text.Equals(userId))
                return 7;
            else if (string.IsNullOrEmpty(this.remoteUserLabel8.Text) || this.remoteUserLabel8.Text.Equals(userId))
                return 8;
            else if (string.IsNullOrEmpty(this.remoteUserLabel9.Text) || this.remoteUserLabel9.Text.Equals(userId))
                return 9;
            else if (string.IsNullOrEmpty(this.remoteUserLabel10.Text) || this.remoteUserLabel10.Text.Equals(userId))
                return 10;
            else if(string.IsNullOrEmpty(this.remoteUserLabel11.Text) || this.remoteUserLabel11.Text.Equals(userId))
                return 11;
            else if (string.IsNullOrEmpty(this.remoteUserLabel12.Text) || this.remoteUserLabel12.Text.Equals(userId))
                return 12;
            else if (string.IsNullOrEmpty(this.remoteUserLabel13.Text) || this.remoteUserLabel13.Text.Equals(userId))
                return 13;
            else if (string.IsNullOrEmpty(this.remoteUserLabel14.Text) || this.remoteUserLabel14.Text.Equals(userId))
                return 14;
            else if (string.IsNullOrEmpty(this.remoteUserLabel15.Text) || this.remoteUserLabel15.Text.Equals(userId))
                return 15;
            else if(string.IsNullOrEmpty(this.remoteUserLabel16.Text) || this.remoteUserLabel16.Text.Equals(userId))
                return 16;
            else if (string.IsNullOrEmpty(this.remoteUserLabel17.Text) || this.remoteUserLabel17.Text.Equals(userId))
                return 17;
            else if (string.IsNullOrEmpty(this.remoteUserLabel18.Text) || this.remoteUserLabel18.Text.Equals(userId))
                return 18;
            else if (string.IsNullOrEmpty(this.remoteUserLabel19.Text) || this.remoteUserLabel19.Text.Equals(userId))
                return 19;
            else if (string.IsNullOrEmpty(this.remoteUserLabel20.Text) || this.remoteUserLabel20.Text.Equals(userId))
                return 20;
            else if(string.IsNullOrEmpty(this.remoteUserLabel21.Text) || this.remoteUserLabel21.Text.Equals(userId))
                return 21;
            else if (string.IsNullOrEmpty(this.remoteUserLabel22.Text) || this.remoteUserLabel22.Text.Equals(userId))
                return 22;
            else if (string.IsNullOrEmpty(this.remoteUserLabel23.Text) || this.remoteUserLabel23.Text.Equals(userId))
                return 23;
            return -1;
        }
        ...
        private int FindOccupyRemoteVideoPosition(string userId, bool isExitRoom)
        {
            ...
            if (this.remoteUserLabel6.Text.Equals(userId))
            {
                pos = 6;
                if (isExitRoom)
                    this.remoteUserLabel6.Text = "";
            }
            if (this.remoteUserLabel7.Text.Equals(userId))
            {
                pos = 7;
                if (isExitRoom)
                    this.remoteUserLabel7.Text = "";
            }
            if (this.remoteUserLabel8.Text.Equals(userId))
            {
                pos = 8;
                if (isExitRoom)
                    this.remoteUserLabel8.Text = "";
            }
            if (this.remoteUserLabel9.Text.Equals(userId))
            {
                pos = 9;
                if (isExitRoom)
                    this.remoteUserLabel9.Text = "";
            }
            if (this.remoteUserLabel10.Text.Equals(userId))
            {
                pos = 10;
                if (isExitRoom)
                    this.remoteUserLabel10.Text = "";
            }

            if (this.remoteUserLabel11.Text.Equals(userId))
            {
                pos = 11;
                if (isExitRoom)
                    this.remoteUserLabel11.Text = "";
            }
            if (this.remoteUserLabel12.Text.Equals(userId))
            {
                pos = 12;
                if (isExitRoom)
                    this.remoteUserLabel12.Text = "";
            }
            if (this.remoteUserLabel13.Text.Equals(userId))
            {
                pos = 13;
                if (isExitRoom)
                    this.remoteUserLabel13.Text = "";
            }
            if (this.remoteUserLabel14.Text.Equals(userId))
            {
                pos = 14;
                if (isExitRoom)
                    this.remoteUserLabel14.Text = "";
            }
            if (this.remoteUserLabel15.Text.Equals(userId))
            {
                pos = 15;
                if (isExitRoom)
                    this.remoteUserLabel15.Text = "";
            }

            if (this.remoteUserLabel16.Text.Equals(userId))
            {
                pos = 16;
                if (isExitRoom)
                    this.remoteUserLabel16.Text = "";
            }
            if (this.remoteUserLabel17.Text.Equals(userId))
            {
                pos = 17;
                if (isExitRoom)
                    this.remoteUserLabel17.Text = "";
            }
            if (this.remoteUserLabel18.Text.Equals(userId))
            {
                pos = 18;
                if (isExitRoom)
                    this.remoteUserLabel18.Text = "";
            }
            if (this.remoteUserLabel19.Text.Equals(userId))
            {
                pos = 19;
                if (isExitRoom)
                    this.remoteUserLabel19.Text = "";
            }
            if (this.remoteUserLabel20.Text.Equals(userId))
            {
                pos = 20;
                if (isExitRoom)
                    this.remoteUserLabel20.Text = "";
            }

            if (this.remoteUserLabel21.Text.Equals(userId))
            {
                pos = 21;
                if (isExitRoom)
                    this.remoteUserLabel21.Text = "";
            }
            if (this.remoteUserLabel22.Text.Equals(userId))
            {
                pos = 22;
                if (isExitRoom)
                    this.remoteUserLabel22.Text = "";
            }

            if (this.remoteUserLabel23.Text.Equals(userId))
            {
                pos = 23;
                if (isExitRoom)
                    this.remoteUserLabel23.Text = "";
            }
        ...
        private Panel GetPanelAndSetUserId(int pos, string userId, bool isSetUserId = true, bool isOpenSubStream = false)
        {
            switch (pos)
            {
                ...
                case 6:
                    if (isSetUserId)
                        this.remoteUserLabel6.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel6;
                case 7:
                    if (isSetUserId)
                        this.remoteUserLabel7.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel7;
                case 8:
                    if (isSetUserId)
                        this.remoteUserLabel8.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel8;
                case 9:
                    if (isSetUserId)
                        this.remoteUserLabel9.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel9;
                case 10:
                    if (isSetUserId)
                        this.remoteUserLabel10.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel10;


                case 11:
                    if (isSetUserId)
                        this.remoteUserLabel11.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel11;
                case 12:
                    if (isSetUserId)
                        this.remoteUserLabel12.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel12;
                case 13:
                    if (isSetUserId)
                        this.remoteUserLabel13.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel13;
                case 14:
                    if (isSetUserId)
                        this.remoteUserLabel14.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel14;
                case 15:
                    if (isSetUserId)
                        this.remoteUserLabel15.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel15;


                case 16:
                    if (isSetUserId)
                        this.remoteUserLabel16.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel16;
                case 17:
                    if (isSetUserId)
                        this.remoteUserLabel17.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel17;
                case 18:
                    if (isSetUserId)
                        this.remoteUserLabel18.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel18;
                case 19:
                    if (isSetUserId)
                        this.remoteUserLabel19.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel19;
                case 20:
                    if (isSetUserId)
                        this.remoteUserLabel20.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel20;


                case 21:
                    if (isSetUserId)
                        this.remoteUserLabel21.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel21;
                case 22:
                    if (isSetUserId)
                        this.remoteUserLabel22.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel22;
                case 23:
                    if (isSetUserId)
                        this.remoteUserLabel23.Text = userId + (isOpenSubStream ? "(屏幕分享)" : "");
                    return this.remoteVideoPanel23;             
                default:
                    return null;
            }
        }
        ...
        private void SetVisableInfoView(int pos, bool visable)
        {
            switch (pos)
            {
                ...
                case 6:
                    this.remoteInfoLabel6.Visible = visable;
                    break;
                case 7:
                    this.remoteInfoLabel7.Visible = visable;
                    break;
                case 8:
                    this.remoteInfoLabel8.Visible = visable;
                    break;
                case 9:
                    this.remoteInfoLabel9.Visible = visable;
                    break;
                case 10:
                    this.remoteInfoLabel10.Visible = visable;
                    break;

                case 11:
                    this.remoteInfoLabel11.Visible = visable;
                    break;
                case 12:
                    this.remoteInfoLabel12.Visible = visable;
                    break;
                case 13:
                    this.remoteInfoLabel13.Visible = visable;
                    break;
                case 14:
                    this.remoteInfoLabel14.Visible = visable;
                    break;
                case 15:
                    this.remoteInfoLabel15.Visible = visable;
                    break;

                case 16:
                    this.remoteInfoLabel16.Visible = visable;
                    break;
                case 17:
                    this.remoteInfoLabel17.Visible = visable;
                    break;
                case 18:
                    this.remoteInfoLabel18.Visible = visable;
                    break;
                case 19:
                    this.remoteInfoLabel19.Visible = visable;
                    break;
                case 20:
                    this.remoteInfoLabel20.Visible = visable;
                    break;

                case 21:
                    this.remoteInfoLabel21.Visible = visable;
                    break;
                case 22:
                    this.remoteInfoLabel22.Visible = visable;
                    break;
                case 23:
                    this.remoteInfoLabel23.Visible = visable;
                    break;
            }
        }
        ...
        private void SetRemoteVoiceVisable(int pos, bool visable)
        {
            ...
            if (pos == 6)
                this.remoteVoiceProgressBar6.Visible = visable;
            if (pos == 7)
                this.remoteVoiceProgressBar7.Visible = visable;
            if (pos == 8)
                this.remoteVoiceProgressBar8.Visible = visable;
            if (pos == 9)
                this.remoteVoiceProgressBar9.Visible = visable;
            if (pos == 10)
                this.remoteVoiceProgressBar10.Visible = visable;

            if (pos == 11)
                this.remoteVoiceProgressBar11.Visible = visable;
            if (pos == 12)
                this.remoteVoiceProgressBar12.Visible = visable;
            if (pos == 13)
                this.remoteVoiceProgressBar13.Visible = visable;
            if (pos == 14)
                this.remoteVoiceProgressBar14.Visible = visable;
            if (pos == 15)
                this.remoteVoiceProgressBar15.Visible = visable;

            if (pos == 16)
                this.remoteVoiceProgressBar16.Visible = visable;
            if (pos == 17)
                this.remoteVoiceProgressBar17.Visible = visable;
            if (pos == 18)
                this.remoteVoiceProgressBar18.Visible = visable;
            if (pos == 19)
                this.remoteVoiceProgressBar19.Visible = visable;
            if (pos == 20)
                this.remoteVoiceProgressBar20.Visible = visable;

            if (pos == 21)
                this.remoteVoiceProgressBar21.Visible = visable;
            if (pos == 22)
                this.remoteVoiceProgressBar22.Visible = visable;
            if (pos == 23)
                this.remoteVoiceProgressBar23.Visible = visable;
        }
        ...
        private void SetRemoteVoiceVolume(string userId, int volume)
        {
            ...
            if (this.remoteUserLabel6.Text.Equals(userId) && this.remoteVoiceProgressBar6.Visible)
                this.remoteVoiceProgressBar6.Value = volume;
            else if (this.remoteUserLabel7.Text.Equals(userId) && this.remoteVoiceProgressBar7.Visible)
                this.remoteVoiceProgressBar7.Value = volume;
            else if (this.remoteUserLabel8.Text.Equals(userId) && this.remoteVoiceProgressBar8.Visible)
                this.remoteVoiceProgressBar8.Value = volume;
            else if (this.remoteUserLabel9.Text.Equals(userId) && this.remoteVoiceProgressBar9.Visible)
                this.remoteVoiceProgressBar9.Value = volume;
            else if (this.remoteUserLabel10.Text.Equals(userId) && this.remoteVoiceProgressBar10.Visible)
                this.remoteVoiceProgressBar10.Value = volume;

            if (this.remoteUserLabel11.Text.Equals(userId) && this.remoteVoiceProgressBar11.Visible)
                this.remoteVoiceProgressBar11.Value = volume;
            else if (this.remoteUserLabel12.Text.Equals(userId) && this.remoteVoiceProgressBar12.Visible)
                this.remoteVoiceProgressBar12.Value = volume;
            else if (this.remoteUserLabel13.Text.Equals(userId) && this.remoteVoiceProgressBar13.Visible)
                this.remoteVoiceProgressBar13.Value = volume;
            else if (this.remoteUserLabel14.Text.Equals(userId) && this.remoteVoiceProgressBar14.Visible)
                this.remoteVoiceProgressBar14.Value = volume;
            else if (this.remoteUserLabel15.Text.Equals(userId) && this.remoteVoiceProgressBar15.Visible)
                this.remoteVoiceProgressBar15.Value = volume;

            if (this.remoteUserLabel16.Text.Equals(userId) && this.remoteVoiceProgressBar16.Visible)
                this.remoteVoiceProgressBar16.Value = volume;
            else if (this.remoteUserLabel17.Text.Equals(userId) && this.remoteVoiceProgressBar17.Visible)
                this.remoteVoiceProgressBar17.Value = volume;
            else if (this.remoteUserLabel18.Text.Equals(userId) && this.remoteVoiceProgressBar18.Visible)
                this.remoteVoiceProgressBar18.Value = volume;
            else if (this.remoteUserLabel19.Text.Equals(userId) && this.remoteVoiceProgressBar19.Visible)
                this.remoteVoiceProgressBar19.Value = volume;
            else if (this.remoteUserLabel20.Text.Equals(userId) && this.remoteVoiceProgressBar20.Visible)
                this.remoteVoiceProgressBar20.Value = volume;

            if (this.remoteUserLabel21.Text.Equals(userId) && this.remoteVoiceProgressBar21.Visible)
                this.remoteVoiceProgressBar21.Value = volume;
            else if (this.remoteUserLabel22.Text.Equals(userId) && this.remoteVoiceProgressBar22.Visible)
                this.remoteVoiceProgressBar22.Value = volume;
            else if (this.remoteUserLabel23.Text.Equals(userId) && this.remoteVoiceProgressBar23.Visible)
                this.remoteVoiceProgressBar23.Value = volume;
        }
        ...
        public void setRichEditText(string text)
        {
            //this.richTextBox2.Text += "\n";
            //this.richTextBox2.Text += text;
            //如果是跨线程访问控件，则执行委托完成对控件的实际调用。
            //if (this.richTextBox2.InvokeRequired)
            //{
            //    this.richTextBox2.Invoke(
            //                new Action<string>(delegate (string n)
            //                {
            //                    this.richTextBox2.Text += "\n";
            //                    this.richTextBox2.Text += n;
            //                }), text);
            //}
